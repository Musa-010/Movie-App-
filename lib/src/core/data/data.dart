...
final section1 = List.generate(
  16,
  (index) =>
      Seat(isHidden: [0, 1, 4].contains(index), isOccupied: [].contains(index)),
);
...
final section4 = List.generate(
  20,
  (index) =>
      Seat(isHidden: [].contains(index), isOccupied: [1, 2, 3].contains(index)),
);

final section5 = List.generate(
  20,
  (index) => Seat(isHidden: [].contains(index), isOccupied: [].contains(index)),
);

final section6 = List.generate(
  20,
  (index) =>
      Seat(isHidden: [].contains(index), isOccupied: [14].contains(index)),
);
